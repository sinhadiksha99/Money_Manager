...
const currentMonthPreview = async (req, res) => {
  ...
  try {
    ...
    logger.log({
      level: "error",
      message: "Current Month Preview" + err,
    });
    return res.status(400).json({
      error: errorHandler.getErrorMessage(err),
    });
