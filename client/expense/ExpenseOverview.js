      ...
      >
        ...
        <Typography component="span" className={classes.totalSpent}>
          ...
          {expensePreview.month
            ? numberWithCommas(expensePreview.month.totalSpent)
            : "0"}{" "}
            ...
            >
              ...
              <div style={{ marginBottom: 3 }}>
                <Typography
                  ...
                  style={{ color: "#595555", fontSize: "1.35em" }}
                >
                  ₹{numberWithCommas(expense.mergedValues.average)}
                </Typography>
                <Typography
                  component="span"
                  className={classes.val}
                ...
                >
                  ₹
                  {expense.mergedValues.total
                    ? numberWithCommas(expense.mergedValues.total)
                    : 0}
                </Typography>
                <Typography
                  component="span"
                  className={classes.val}
                  style={{
                    color: indicateExpense(expense.mergedValues),
                    fontSize: "1.35em",
                  }}
                >
                  ₹
